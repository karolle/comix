...
Warbler::Config.new do |config|
  ...
  # config.gems << "tzinfo"
  config.gems = ["actionmailer", "actionpack", "activerecord", "activerecord-jdbc-adapter", "activerecord-jdbcmysql-adapter", "activeresource", "activesupport", "jdbc-mysql", "jruby-openssl", "rails", 'rubyzip']
